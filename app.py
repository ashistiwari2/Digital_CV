...
with st.container ():
    ...
    github={'github':"""<div class="github-card" data-user="ashistiwari2"></div> <script src="http://lab.lepture.com/github-cards/widget.js"></script>"""}
    ...
    with st.sidebar:
            ...
            components.html(fb['facebook'],height=800)
